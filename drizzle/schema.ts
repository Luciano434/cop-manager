...
export const procedures = mysqlTable("procedures", {
  ...
  status: mysqlEnum("status", ["nao_iniciado", "em_desenvolvimento", "aprovado", "em_revisao", "em_elaboracao", "bloqueado", "cancelado"]).notNull().default("nao_iniciado"),
...
export const procedureRevisions = mysqlTable("procedure_revisions", {
  ...
  revision: varchar("revision", { length: 20 }).notNull().default("R00"),
  status: mysqlEnum("status", ["nao_iniciado", "em_desenvolvimento", "aprovado", "em_revisao", "em_elaboracao", "bloqueado", "cancelado"]).notNull().default("aprovado"),
  sections: text("sections"),
  name: text("name"),
  description: text("description"),
  responsible: varchar("responsible", { length: 255 }),
